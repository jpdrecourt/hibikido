...
def test_invocation_manifestation_flow():
    ...
    try:
        ...
        db.add_recording(recording_path, metadata={"description": "Test sounds for invocation"})
...
def test_queue_all_strategy():
    ...
    try:
        ...
        db.add_recording(recording_path, metadata={"description": "Multiple test sounds"})
